...
| `aspLsp.inlayHints.globalVariableMarkers`  | `global`                 | Show VBScript variable scope markers, `global`, `all`, or `off`; uncertain include-related implicit variables use `(?)`.                         |
