...
| `aspLsp.workspace.idleAnalysisConcurrency` | `0`                      | Maximum unopened Classic ASP files analyzed concurrently while idle; `0` uses available CPU count.                                               |
| `aspLsp.workspace.busyAnalysisConcurrency` | `0`                      | Maximum unopened Classic ASP files analyzed concurrently while foreground work is pending; `0` uses half the available CPU count.                |
