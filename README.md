...
| `aspLsp.graph.showBuiltinSymbols`             | `false`                  | Show built-in VBScript, Classic ASP, and catalog object symbols in graph views.                                                                  |
| `aspLsp.graph.showConfiguredGlobals`          | `false`                  | Show VBScript globals from `aspLsp.vbscript.globals` in graph views.                                                                             |
| `aspLsp.graph.showConfiguredComTypes`         | `false`                  | Show custom COM types from `aspLsp.vbscript.comTypes` in graph views.                                                                            |
| `aspLsp.graph.showObjectMembers`              | `false`                  | Show object member nodes for built-in and configured object types in graph views.                                                                |
| `aspLsp.graph.showFunctionParameters`         | `false`                  | Show function, sub, method, and property parameter nodes in graph views.                                                                         |
| `aspLsp.graph.showLocalVariables`             | `false`                  | Show procedure-local VBScript variable nodes in graph views.                                                                                     |
| `aspLsp.graph.showLocalConstants`             | `false`                  | Show procedure-local VBScript constant nodes in graph views.                                                                                     |
| `aspLsp.graph.showClassFields`                | `false`                  | Show class field nodes in graph views.                                                                                                           |
| `aspLsp.graph.showClassMethods`               | `false`                  | Show class method nodes in graph views.                                                                                                          |
| `aspLsp.graph.showClassProperties`            | `false`                  | Show class property nodes in graph views.                                                                                                        |
| `aspLsp.graph.showClassConstants`             | `false`                  | Show class constant nodes in graph views.                                                                                                        |
| `aspLsp.graph.showClasses`                    | `true`                   | Show class nodes in graph views.                                                                                                                 |
| `aspLsp.graph.showFunctions`                  | `true`                   | Show function nodes in graph views.                                                                                                              |
| `aspLsp.graph.showSubs`                       | `true`                   | Show subroutine nodes in graph views.                                                                                                            |
| `aspLsp.graph.showGlobalVariables`            | `true`                   | Show global VBScript variable nodes in graph views.                                                                                              |
| `aspLsp.graph.showGlobalConstants`            | `true`                   | Show global VBScript constant nodes in graph views.                                                                                              |
| `aspLsp.graph.showFiles`                      | `true`                   | Show existing file nodes in graph views.                                                                                                         |
| `aspLsp.graph.showMissingFiles`               | `true`                   | Show missing include file nodes in graph views.                                                                                                  |
| `aspLsp.graph.showIncludeLinks`               | `true`                   | Show include links in graph views.                                                                                                               |
| `aspLsp.graph.showDeclarationLinks`           | `true`                   | Show file-to-declaration links in graph views.                                                                                                   |
...
| `aspLsp.graph.showUnresolvedReferences`       | `true`                   | Show unresolved reference nodes and links in graph views.                                                                                        |
