...
| `aspLsp.graph.showObjectMembers`              | `false`                  | Show built-in, configured, and unresolved object member nodes in graph views.                                                                    |
...
| `aspLsp.graph.showDeclarationLinks`           | `true`                   | Show declaration-to-source links in graph views.                                                                                                 |
