...
- `aspLsp.debug.output`: debug timing output, `off`, `summary`, or `verbose`; VS Code highlights timing logs from green through yellow, orange, and red by elapsed duration
