...
| `aspLsp.graph.showClassFields`                | `true`                   | Show class field nodes in graph views.                                                                                                           |
| `aspLsp.graph.showClassMethods`               | `true`                   | Show class method nodes in graph views.                                                                                                          |
| `aspLsp.graph.showClassProperties`            | `true`                   | Show class property nodes in graph views.                                                                                                        |
| `aspLsp.graph.showClassConstants`             | `true`                   | Show class constant nodes in graph views.                                                                                                        |
